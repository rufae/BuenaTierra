...
export default function Lotes() {
  ...
  const totalLotes = filtrados.length
  const lotesActivos = filtrados.filter(s => getEstado(s) === 'activo').length
  const lotesBajos = filtrados.filter(s => s.cantidadDisponible > 0 && s.cantidadDisponible < 5).length
